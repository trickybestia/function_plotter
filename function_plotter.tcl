...
set _xil_proj_name_ "function_plotter"
...
set script_file "function_plotter.tcl"
...
# Create 'fill_drawer_tb' fileset (if not found)
if {[string equal [get_filesets -quiet fill_drawer_tb] ""]} {
  create_fileset -simset fill_drawer_tb
}
...
# Set 'fill_drawer_tb' fileset file properties for remote files
# None

# Set 'fill_drawer_tb' fileset file properties for local files
# None
...
# Create 'vga_tb' fileset (if not found)
if {[string equal [get_filesets -quiet vga_tb] ""]} {
  create_fileset -simset vga_tb
}
...
# Set 'vga_tb' fileset file properties for remote files
# None

# Set 'vga_tb' fileset file properties for local files
# None
...
# Create 'symbol_drawer_mem_tb' fileset (if not found)
if {[string equal [get_filesets -quiet symbol_drawer_mem_tb] ""]} {
  create_fileset -simset symbol_drawer_mem_tb
}

# Set 'symbol_drawer_mem_tb' fileset object
...
# Set 'symbol_drawer_mem_tb' fileset file properties for remote files
# None

# Set 'symbol_drawer_mem_tb' fileset file properties for local files
# None
...
# Create 'symbol_drawer_tb' fileset (if not found)
if {[string equal [get_filesets -quiet symbol_drawer_tb] ""]} {
  create_fileset -simset symbol_drawer_tb
}

# Set 'symbol_drawer_tb' fileset object
...
# Set 'symbol_drawer_tb' fileset file properties for remote files
# None

# Set 'symbol_drawer_tb' fileset file properties for local files
# None
...
# Create 'logic_tb' fileset (if not found)
if {[string equal [get_filesets -quiet logic_tb] ""]} {
  create_fileset -simset logic_tb
}

# Set 'logic_tb' fileset object
set obj [get_filesets logic_tb]
set files [list \
 [file normalize "${origin_dir}/src/testbench/logic_tb.v"] \
]
add_files -norecurse -fileset $obj $files

# Set 'logic_tb' fileset file properties for remote files
# None

# Set 'logic_tb' fileset file properties for local files
# None

# Set 'logic_tb' fileset properties
set obj [get_filesets logic_tb]
set_property -name "sim_wrapper_top" -value "1" -objects $obj
set_property -name "top" -value "logic_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_lib" -value "xil_defaultlib" -objects $obj
...
# Create 'fixed_point_add_tb' fileset (if not found)
if {[string equal [get_filesets -quiet fixed_point_add_tb] ""]} {
  create_fileset -simset fixed_point_add_tb
}

# Set 'fixed_point_add_tb' fileset object
...
# Set 'fixed_point_add_tb' fileset file properties for remote files
# None

# Set 'fixed_point_add_tb' fileset file properties for local files
# None
...
# Create 'fixed_point_sub_tb' fileset (if not found)
if {[string equal [get_filesets -quiet fixed_point_sub_tb] ""]} {
  create_fileset -simset fixed_point_sub_tb
}

# Set 'fixed_point_sub_tb' fileset object
...
# Set 'fixed_point_sub_tb' fileset file properties for remote files
# None

# Set 'fixed_point_sub_tb' fileset file properties for local files
# None
...
# Create 'fixed_point_mul_tb' fileset (if not found)
if {[string equal [get_filesets -quiet fixed_point_mul_tb] ""]} {
  create_fileset -simset fixed_point_mul_tb
}
...
# Set 'fixed_point_mul_tb' fileset file properties for remote files
# None

# Set 'fixed_point_mul_tb' fileset file properties for local files
# None
...
# Create 'fixed_point_alu_tb' fileset (if not found)
if {[string equal [get_filesets -quiet fixed_point_alu_tb] ""]} {
  create_fileset -simset fixed_point_alu_tb
}

# Set 'fixed_point_alu_tb' fileset object
...
# Set 'fixed_point_alu_tb' fileset file properties for remote files
# None

# Set 'fixed_point_alu_tb' fileset file properties for local files
# None
